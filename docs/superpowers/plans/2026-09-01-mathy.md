          ...
          <div className="rows">
            {recent.map((s) => (
              <div className="row" key={s.id}>
                ...
                <span className="val">
                  {s.aborted ? 'прервано' : '★'.repeat(s.stars) + '☆'.repeat(5 - s.stars)}
                </span>
              </div>
            ))}
          </div>
...
- Modify: `src/ui/practice/PracticeFlow.tsx`, `src/ui/StartScreen.tsx`
...
- [ ] **Step 2: Переиспользовать форматирование на стартовом экране**
...
- [ ] **Step 3: Создать модалку результата**
...
- [ ] **Step 4: Подключить модалку к потоку**
